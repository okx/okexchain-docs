...
First, you need to [install the software](/okc/docs/dev/quick-start/install-okc.html).

Then, you can start [running a full-node(testnet)](/okc/docs/dev/quick-start/join-okc-testnet.html).
