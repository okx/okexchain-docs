...
#### Install OKBC
   Make sure you have the OKBC application installed, [installation instructions](/dev/build-dapps/build-on-okbc/get-started/install-okbc.html).
#### Install Rust
...
#### Mainnet
Mainnet does not need to set up nodes; you can directly access RPC node services provided by OKBC for developing OKBC wasm contracts. If you need to build your own test network node, please refer to [testnet node set up](/dev/build-dapps/build-on-okbc/get-started/join-public-testnet.html).
...
#### Testnet
Testnet does not need to set up nodes; you can directly access RPC node services provided by OKBC for developing OKBC wasm contracts. If you need to build your own test network node, please refer to [testnet node set up](/dev/build-dapps/build-on-okbc/get-started/join-public-testnet.html).
