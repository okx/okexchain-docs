...
Now, We have to deploy our smart contract on OKBC Network. For that, we have to connect to web3 world, this can be done my many services like Metamask, Brave, Portis etc. We will be using Metamask. Please follow this [tutorial to setup a Metamask Account](/dev/build-dapps/build-on-okbc/wallet/metamask/overview.html).
...
- Testnet:   
    [RPC URLs](/dev/build-dapps/okbc-api/json-rpc-api.html)   
    ChainID: 195   
    Symbol: OKB   
