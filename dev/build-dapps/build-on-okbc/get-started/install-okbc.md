...
testnet as a [Full Node](/dev/build-dapps/build-on-okbc/get-started/join-public-testnet.html).
...
Now you can [join the public testnet](/dev/build-dapps/build-on-okbc/get-started/join-public-testnet.html) or [create you own testnet](/dev/build-dapps/build-on-okbc/get-started/deploy-your-own-okbc-localnet.html)
