...
truffle compile
```
Config Truffle for OKBC
- Go to truffle-config.js
- Update the truffle-config with OKBC-network-crendentials.
```
...
module.exports = {
  networks: {
    development: {
      ...
      port: 8545,            // Standard OKBC port (default: none)
...
## Deploying on OKBC Network
Run this command in root of the project directory:
```
$ truffle migrate --network testnet
```
Contract will be deployed on OKBC Chapel Testnet, it look like this:
```
