...
- Testnet * [RPC URLs](/okc/docs/dev/api/okc-api/grpc-api.html) * ChainID: exchain-65 * Symbol: OKT * Block Explorer:
https://www.oklink.com/okc-test
- Mainnet * [RPC URLs](/okc/docs/dev/api/okc-api/grpc-api.html) * ChainID: exchain-66 * Symbol: OKT * Block Explorer: 
