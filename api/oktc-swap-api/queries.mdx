...
To try these queries and run your own visit the <LinkNotWithLangPath text='graphql page' link='https://www.okx.com/okc/subgraph/name/okcswap/okc-swap-subgraph/graphql' />. To learn more about graphql query refer to [GraphQL API](https://thegraph.com/docs/en/querying/graphql-api/)
