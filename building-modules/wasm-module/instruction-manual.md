...
| 2| bytecode id| Every bytecode has a unique bytecode id after being deployed to OKTC. <br>Increments by natural numbers.<br> The minimum is 1 | | | N/A |
| 3| Contract address | represents a contract instance<br>Generated by: hash(bytecode id, contract id)| | | represents a contract instance <br> Generated by: hash(EOA address, nonce)|
...
| 10| exchaincli tx wasm set-contract-admin| Update contract admin| | y| Change proxy admin by calling:<br> (function changeAdmin) |
| 11| exchaincli tx wasm clear-contract-admin| remove contract admin<br> An irreversible operation| | y| set a blockhole address to proxy admin <br> An irreversible operation|
