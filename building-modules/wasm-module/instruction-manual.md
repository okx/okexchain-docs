...
#### Install OKC
   Make sure you have the OKC application installed, [installation instructions](../getting-start/install-okc.html).
#### Install Rust
...
#### Mainnet
Mainnet does not need to set up nodes; you can directly access RPC node services provided by OKC for developing OKC wasm contracts. If you need to build your own test network node, please refer to [mainnnet node set up](../getting-start/join-okc-mainnet.html).
...
```
#### Testnet
Testnet does not need to set up nodes; you can directly access RPC node services provided by OKC for developing OKC wasm contracts. If you need to build your own test network node, please refer to [testnet node set up](../getting-start/join-okc-testnet.html).
