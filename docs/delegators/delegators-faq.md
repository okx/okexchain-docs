...
You will have the ability to choose if you want to become a delegator on the OKExChain ecosystem. the future of the network may depend on your  votes and those who will manage it.


## Choosing a validator

In order to choose their validators, delegators have access to a range of information directly on [OKLink](https://www.oklink.com/okexchain-test) or other OKExChain block explorers.
