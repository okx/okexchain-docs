...
This document contains all the necessary information for delegators to interact with the OKExChain through the Command-Line Interface (CLI).
...
Please also note that you are about to interact with the OKExChain, a
...
`okexchaincli` lets you query all relevant information from the blockchain, like account balances, amount of bonded tokens, outstanding rewards, governance proposals and more. Next is a list of the most useful commands for delegator. 
