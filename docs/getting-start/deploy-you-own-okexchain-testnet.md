...
* `docker run -it -v ~/.okexchaind:/root/.okexchaind -v ~/.okexchaincli:/root/.okexchaincli okchain/node:$TAG okexchaind init mynode`
* `docker run -it -p 26657:26657 -p 26656:26656 -v ~/.okexchaind:/root/.okexchaind -v ~/.okexchaincli:/root/.okexchaincli okchain/node:$TAG okexchaind start`
* ...
* `docker run -it -v ~/.okexchaind:/root/.okexchaind -v ~/.okexchaincli:/root/.okexchaincli okchain/node:$TAG okexchaincli version`
```
