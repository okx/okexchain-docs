...
[**Install from source**](/dev/quick-start/install-oktc)
...
Use command-line interface (CLI) commands to staking okts and earn rewards as a validator or delegator, you can get it [here](/dev/core-concepts/delegator/delegators-guide-cli).
